...
Label(Frame1, text="").pack()
Label(Frame1, text="Autoregression order (p) : 1").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Differenciation order (d) : 1").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Moving average order (q) : 1").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="SEASONAL ELEMENTS").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Autoregressive order (P) : 0").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Differenciation order (D) : 1").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Moving average order (Q) : 1").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Period (m) : 24").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="").pack()
stats.pack()
...
img1 = ImageTk.PhotoImage(file="data/Prediction_Result_for_Monday.png")
img2 = ImageTk.PhotoImage(file="data/Prediction_nbCLient_for_Monday.png")
img3 = ImageTk.PhotoImage(file="data/Prediction_Bandwidth_Mo.s_for_Monday.png")
