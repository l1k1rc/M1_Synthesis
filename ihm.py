...
def boutonFourreTout():
    ...
    newWindow.maxsize(500, 710)
    newWindow.minsize(500, 710)

    n = ttk.Notebook(newWindow)  # Création du système d'onglets
    n.pack()
    o1 = ttk.Frame(n, width=450, height=500)  # Ajout de l'onglet 1
    o1.pack()
    o2 = ttk.Frame(n, width=450, height=500)  # Ajout de l'onglet 2
    o2.pack()
    o3 = ttk.Frame(n, width=450, height=500)  # Ajout de l'onglet 3
    o3.pack()
    ...
    lab1c1 = Label(o1, text="hour |")

    lab2c1 = Label(o2, text="hour |")

    lab3c1 = Label(o3, text="hour |")

    lab1 = Label(o1, text=" Estimated bandwidth ")
    lab1.grid(row=0, column=1, sticky=W, pady=0)

    lab1 = Label(o1, text="| Estimated clients ")
    lab1.grid(row=0, column=2, sticky=W, pady=0)

    lab2 = Label(o2, text=" Estimated bandwidth ")
    lab2.grid(row=0, column=1, sticky=W, pady=0)

    lab2 = Label(o2, text="| Estimated clients ")
    lab2.grid(row=0, column=2, sticky=W, pady=0)

    lab3 = Label(o3, text=" Estimated bandwidth ")
    lab3.grid(row=0, column=1, sticky=W, pady=0)

    lab3 = Label(o3, text="| Estimated clients ")
    lab3.grid(row=0, column=2, sticky=W, pady=0)
    ...
    l = Label(o1, text="-------")
    l.grid(row=2, column=0, sticky=W, pady=0)
    l = Label(o1, text="----------------------------------------")
    l1 = Label(o1, text="------------------------------")
    l.grid(row=2, column=1, sticky=W, pady=0)
    l1.grid(row=2, column=2, sticky=W, pady=0)
    ...
    l2 = Label(o2, text="------------------------------")
    l.grid(row=2, column=1, sticky=W, pady=0)
    l2.grid(row=2, column=2, sticky=W, pady=0)
    ...
    l3 = Label(o3, text="------------------------------")
    l.grid(row=2, column=1, sticky=W, pady=0)
    l3.grid(row=2, column=2, sticky=W, pady=0)

    with open('data/estimated_bandwidth_Monday.csv') as f:
        f_csv = csv.reader(f)
        x=3
        for ligne in f_csv:
            if x==28:
    ...
    with open('data/estimated_client_Monday.csv') as f:
        f_csv = csv.reader(f)
        x=3
        for ligne in f_csv:
            if x==28:
                break
            l = Label(o1, text="| "+ligne[1])
            l.grid(row=x, column=2, sticky=W, pady=0)
            x=x+1

    with open('data/estimated_bandwidth_Tuesday.csv') as f:
        f_csv = csv.reader(f)
        x=3
        for ligne in f_csv:
            if x==28:
    ...
    with open('data/estimated_client_Tuesday.csv') as f:
        f_csv = csv.reader(f)
        x=3
        for ligne in f_csv:
            if x==28:
    ...
    with open('data/estimated_bandwidth_Wednesday.csv') as f:
        f_csv = csv.reader(f)
        x=3
        for ligne in f_csv:
            if x==28:
    ...
    with open('data/estimated_client_Wednesday.csv') as f:
        f_csv = csv.reader(f)
        x=3
        for ligne in f_csv:
            if x==28:
...
Label(Frame1, text="Informations", font=("Helvetica", 18)).pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Users per hotspot (max) : 8").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Bandwidth per hotspot (max) : 20").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="number of hotpots (max) : 6").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Learning time and forecast : 120").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="TREND ELEMENTS").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Autoregression order (1)").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Differenciation order (1)").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Moving average order (3)").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="SEASONAL ELEMENTS").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Autoregressive order (1)").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Differenciation order (1)").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Moving average order (3)").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="Period (24)").pack()
Label(Frame1, text="").pack()
Label(Frame1, text="").pack()
stats.pack()
...
img1 = Image.open('data/borneNB_forecasting.PNG')
img1 = resizeimage.resize_thumbnail(img1, [800, 700])
img1.save('data/borneNB_forecasting.PNG', img1.format)

img2 = Image.open('data/forecasting_bandwidth.PNG')
img2 = resizeimage.resize_thumbnail(img2, [800, 700])
img2.save('data/forecasting_bandwidth.PNG', img2.format)

img3 = Image.open('data/forecasting_client.PNG')
img3 = resizeimage.resize_thumbnail(img3, [800, 700])
img3.save('data/forecasting_client.PNG', img3.format)
...
img5.save('data/Prediction_Bandwidth_Mo.s_for_Tuesday.png', img5.format)

img6 = Image.open('data/Prediction_nbCLient_for_Tuesday.png')
img6 = resizeimage.resize_thumbnail(img6, [800, 700])
img6.save('data/Prediction_nbCLient_for_Tuesday.png', img6.format)

img7 = Image.open('data/Prediction_Result_for_Tuesday.png')
img7 = resizeimage.resize_thumbnail(img7, [800, 700])
img7.save('data/Prediction_Result_for_Tuesday.png', img3.format)

img8 = Image.open('data/Prediction_Bandwidth_Mo.s_for_Wednesday.png')
img8 = resizeimage.resize_thumbnail(img8, [800, 700])
img8.save('data/Prediction_Bandwidth_Mo.s_for_Wednesday.png', img8.format)

img9 = Image.open('data/Prediction_nbCLient_for_Wednesday.png')
img9 = resizeimage.resize_thumbnail(img9, [800, 700])
img9.save('data/Prediction_nbCLient_for_Wednesday.png', img9.format)

img10 = Image.open('data/Prediction_Result_for_Wednesday.png')
img10 = resizeimage.resize_thumbnail(img10, [800, 700])
img10.save('data/Prediction_Result_for_Wednesday.png', img10.format)

#img11 = Image.open('stats7.png')
#img11 = resizeimage.resize_thumbnail(img11, [800, 700])
#img11.save('stats7.PNG', img11.format)

img1 = ImageTk.PhotoImage(file="data/borneNB_forecasting.PNG")
img2 = ImageTk.PhotoImage(file="data/forecasting_bandwidth.PNG")
img3 = ImageTk.PhotoImage(file="data/forecasting_client.PNG")
img4 = ImageTk.PhotoImage(file="fleche.jpeg")
img5 = ImageTk.PhotoImage(file="data/Prediction_Bandwidth_Mo.s_for_Tuesday.png")
img6 = ImageTk.PhotoImage(file="data/Prediction_nbCLient_for_Tuesday.png")
img7 = ImageTk.PhotoImage(file="data/Prediction_Result_for_Tuesday.png")
img8 = ImageTk.PhotoImage(file="data/Prediction_Bandwidth_Mo.s_for_Wednesday.png")
img9 = ImageTk.PhotoImage(file="data/Prediction_nbCLient_for_Wednesday.png")
img10 = ImageTk.PhotoImage(file="data/Prediction_Result_for_Wednesday.png")
